...
namespace Sid.Declarations
{
    ...
    public static class DeclarationHelper
    {
        ...
        /// </summary>
        public static IEnumerable<Type> GetModuleTypes(IEnumerable<Assembly> sidModuleAssemblies)
        {
            return sidModuleAssemblies.SelectMany(asm1 => asm1.GetTypes())
                .Where(t => t.IsSubclassOf(typeof(SidModule)) && !t.IsAbstract);
        }
